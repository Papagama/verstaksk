...
const portfolioData = [
  {
    ...
    tag: "Web Application",
    description:
      "Учебный концепт веб-приложения для управления клиентами и проектами с дашбордом, таблицами и интерактивными элементами, созданный как практика проектирования SaaS-интерфейсов.",
...
},
{
  ...
  // Extended attributes for Case Study
  overview:
    "Учебный концептуальный проект веб-приложения Client Flow — системы для управления клиентами, проектами и задачами. Цель — создать функциональный и визуально чистый интерфейс SaaS-приложения с дашбордом, таблицами данных, формами и навигацией. Проект выполнен как практика проектирования сложных интерфейсов и работы с состояниями приложения.",
  ...
  tasks: [
    ...
    "Создать адаптивный интерфейс для работы на разных устройствах"
  ],
  ...
  constraints: [
    ...
    "Важно было сохранить баланс между функциональностью и простотой использования"
  ],

  solution:
    "Я начал с проектирования структуры приложения: определил основные разделы (дашборд, клиенты, проекты, задачи) и логику навигации между ними. Создал дашборд с карточками метрик и графиками для визуализации данных. Реализовал таблицы с возможностью сортировки и фильтрации, формы для добавления и редактирования записей. Основной упор сделал на чистоту интерфейса, понятную иерархию информации и удобство работы с данными.",
  ...
  results: [
    ...
    "Получен практический опыт проектирования сложных веб-приложений"
  ],

  screenshots: {
    desktop: "images/screen8.jpg"
  },

  role:
    "Я выступал в роли UI/UX дизайнера и фронтенд-разработчика: спроектировал архитектуру приложения, создал дизайн интерфейса, реализовал логику работы с данными, формы и навигацию, обеспечил адаптивность и подготовил проект для портфолио.",

  summary:
    "Client Flow — это учебная практика создания полноценного веб-приложения. Проект помог мне отработать проектирование сложных интерфейсов, работу с таблицами и формами, управление состоянием приложения и создание интуитивно понятной навигации в многостраничном SaaS-продукте."
},
{
    id: 2,
    title: "Dream House",
  tag: "Landing",
  description:
    "Лендинг строительной компании каркасных домов с калькулятором стоимости, галереей проектов и интерактивными элементами.",
  ...
  // Extended attributes for Case Study
  overview:
    "Учебный проект лендинга для строительной компании Dream House, специализирующейся на каркасном домостроении. Цель — создать убедительный коммерческий сайт с акцентом на доверие, прозрачность процесса и конкретные цифры. Проект включает интерактивный калькулятор стоимости, галерею реализованных проектов, подробное описание этапов работы и форму заявки.",

  client: "Учебный проект (самостоятельная работа)",
  year: "2026",

  tasks: [
    "Создать убедительный первый экран с ценностным предложением и конкретными цифрами",
    ...
    "Создать галерею проектов с карточками домов и их характеристиками",
    "Добавить блок преимуществ компании с акцентом на гарантии",
    "Реализовать адаптивный дизайн для всех устройств"
  ],

  constraints: [
    "Проект учебный, без реального заказчика",
    "Важно было создать ощущение надежности и профессионализма",
    "Калькулятор должен быть простым, но давать реалистичные расчеты",
    "Необходимо было сбалансировать информативность и визуальную легкость"
  ],

  solution:
    "Я начал с анализа целевой аудитории — людей, планирующих строительство дома. Выстроил структуру страницы по принципу воронки продаж: сильное предложение → преимущества → процесс работы → проекты → калькулятор → галерея → форма заявки. Особое внимание уделил конкретным цифрам (сроки, цены, гарантии) и визуальной подаче процесса строительства. Реализовал работающий калькулятор стоимости с учетом разных параметров дома.",

  technologies: [
    { name: "HTML5", desc: "Семантическая структура страницы и форм" },
    { name: "CSS3", desc: "Современная стилизация, сетки, карточки проектов и адаптивность" },
    { name: "JavaScript (ES6+)", desc: "Интерактивный калькулятор, слайдеры, формы и анимации" },
    { name: "UI/UX дизайн", desc: "Проектирование пользовательского пути и конверсионных элементов" }
  ],

  results: [
    "Создан полноценный коммерческий лендинг строительной компании",
    "Реализован работающий калькулятор стоимости с детальной разбивкой",
    "Выстроена понятная структура процесса строительства",
    "Добавлена галерея проектов с характеристиками и ценами",
    "Сайт корректно работает на всех устройствах",
    "Отработаны принципы создания конверсионных лендингов"
  ],

  screenshots: {
    desktop: "images/screen9.jpg"
  },

  role:
    "Я выступал в роли веб-дизайнера и фронтенд-разработчика: спроектировал структуру лендинга, создал дизайн всех секций, реализовал интерактивный калькулятор и формы, обеспечил адаптивность и подготовил проект для публикации.",

  summary:
    "Dream House — это практика создания коммерческого лендинга с акцентом на конверсию. Я отработал структуру продающей страницы, создание интерактивных элементов (калькулятор), работу с доверием через конкретные цифры и гарантии, а также визуальную подачу сложной информации о процессе строительства."
}
