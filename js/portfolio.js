...
const portfolioData = [
  ...
  // 7. Белые Ягуары - лендинг сообщества
  {
    ...
    title: "Белые Ягуары",
    tag: "Landing",
    description: "Учебный лендинг сообщества с продуманной структурой, тёмной темой и акцентными элементами.",
    ...
    tasks: [
      "Сформировать концепцию и структуру лендинга",
    ...
    summary: "Практика создания атмосферного лендинга с продуманной структурой и визуальной подачей."
  },
